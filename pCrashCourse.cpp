...
//
//----------------------------------------------------------------------
/*!\file    projects/crash_course/pCrashCourse.cpp
 *
 * \author  Javier Alberto Carrasco Melo
 *
 * \date    2022-02-10
 *
 * \brief Contains mCrashCourse
 *
 * \b pCrashCourse
 *
 * This part (program) executes a small robot simulation
 *
 */
//----------------------------------------------------------------------
...
//#include "projects/crash_course/gCrashCourse.h"
...
// Const values
//----------------------------------------------------------------------
const std::string cPROGRAM_DESCRIPTION = "This program executes the CrashCourse module/group.";
...
//  new finroc::crash_course::gCrashCourse(main_thread);
